...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/17 10:00:14 by mabdelma          #+#    #+#             */
/*   Updated: 2023/09/21 13:07:56 by mabdelma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	minishell1(t_mini *mini, t_token *token)
{
	mini->charge = 1;
	mini->parent = 1;
	mini->last = 1;
