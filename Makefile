...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/09/17 10:07:30 by mabdelma          #+#    #+#              #
#    Updated: 2023/09/17 10:07:38 by mabdelma         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXEC = bin builtin exec Exec_Helping

MAIN = minishell redir signal

PARSING = line tokens expansions Tokens_Helping

TOOLS = fd free token type expansions parsing Parse_Helping
