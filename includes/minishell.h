...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/17 10:34:38 by mabdelma          #+#    #+#             */
/*   Updated: 2023/09/22 18:14:46 by mabdelma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				print_error_export(int error, const char *arg);
...
void			squish_args_support(t_mini *mini,
					t_token *token, t_token *prev);
